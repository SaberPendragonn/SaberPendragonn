  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <div style="border: 1px solid #30363d; border-radius: 12px; padding: 20px; background: #0d1117; height: 320px;">
        ...
        <p style="font-size: 14px; margin: 15px 0;">
          <a href="https://github.com/Anthony-Macabata/main-portfolio" style="color: #58a6ff; text-decoration: none;">
            <b>Enterprise Segmentation:</b> Designed VLAN-based isolation and authored custom LCD drivers for performance monitoring.
          </a>
        </p>
      </div>
    </td>
    <td width="50%" align="center" valign="top">
      <div style="border: 1px solid #30363d; border-radius: 12px; padding: 20px; background: #0d1117; height: 320px;">
        ...
        <p style="font-size: 14px; margin: 15px 0;">
          <a href="https://github.com/Anthony-Macabata/main-portfolio" style="color: #58a6ff; text-decoration: none;">
            <b>HWMP+ Mesh:</b> Deployed self-healing wireless mesh with VLAN roaming, increasing usable coverage by 60%.
          </a>
        </p>
      </div>
    </td>
    ...
    <td colspan="2" align="center" valign="top">
      <div style="border: 1px solid #30363d; border-radius: 12px; padding: 20px; background: #0d1117;">
        <p style="font-size: 14px; margin: 5px 0;">
          <a href="https://github.com/Anthony-Macabata/main-portfolio" style="color: #58a6ff; text-decoration: none;">
            <b>DDoS Mitigation:</b> Developed MikroTik firewall filters for multi-vector attacks (SYN/UDP flood), maintaining 100% uptime.
          </a>
        </p>
      </div>
    </td>
